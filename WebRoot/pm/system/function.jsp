...
<body>
	...
	<div id="listPanel" class="easyui-panel" border="false">
		...
		<div id="tb" style="padding:5px;height:auto;border:none;background:none;">
			<table class="table_form2">
				<tr>
					<th>功能代码：</th>
					<td><input name="funcCode" type="text" id="J_funcCode" /></td>
					<th>功能名称：</th>
					<td><input name="funcName" type="text" id="J_funcName" /></td>
			...
			<form id="J_edit_form">
				...
				<table class="table_form" >
				  <tr>
					<th>功能代码：</th>
					<td>
						<input name="funcCode" type="text" id="l_funcCode"  />
					</td>
					<th>功能名称：</th>
					<td>
				  ...
				  <tr>
					<th>功能图标：</th>
					<td>
						<input name="funcIcon" type="text"  />
					</td>
					<th>功能排序：</th>
					<td>
						<input name="funcSort" type="text"  />
					</td>
				  </tr>
				  <tr>
					<th>功能状态：</th>
					<td>
						<select name="funcState" id="l_funcState" >
	...
	/*查询表单*/
	var J_funcCode=$('#J_funcCode');
	var J_funcName=$('#J_funcName');
	
	/*编辑表单 */
	var p_edit_form=$('#p_edit_form');
	var J_operSign=$('#J_operSign');
	var edit_focus = $('#l_funcCode');//增改查操作时，光标首先停留的位置
	...
	function dataGridInit(){
		dataGridTable=$('#dataGrid').datagrid({//实例化table表单
			...
			columns:[[ //数据表格列配置对象
				...
				{field:'funcCode',title:'功能代码',width:80},
				{field:'funcName',title:'功能名称',width:80},
				{field:'funcIcon',title:'功能图标',width:80},
				{field:'funcSort',title:'功能排序',width:60},
				{field:'funcState',title:'功能状态',width:80,
					formatter : function(val, rec) {return formatter(val,'0-停用,1-启用')}
				},
				{field:'funcDesc',title:'功能描述',width:200},
	...
	function searchFun() {
		dataGridTable.datagrid('load',{
			funcCode:J_funcCode.val(),
			funcName:J_funcName.val(),
		});
		return false;
	}

	var opUrl = 'function/oper.do';
	/*确认操作至服务器*/
	...
	function oper(operSign,fName){
		...
		p_edit_form.text(fName+'功能管理信息');//修改编辑表单的标题
		J_operSign.val(operSign);//获取操作码
